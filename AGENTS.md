...
`farsi2epub` converts Farsi (Persian) PDF books into RTL EPUB 3 ebooks using Codex vision models to transcribe page images. It is a CLI (`click`-based) installed as an editable package.
